...
using OnlineExamSystem.Web.Models.Account;
using OnlineExamSystem.Web.Views.Shared.Components.TenantChange;

namespace OnlineExamSystem.Web.Controllers
{
    public class AccountController : OnlineExamSystemControllerBase
    {

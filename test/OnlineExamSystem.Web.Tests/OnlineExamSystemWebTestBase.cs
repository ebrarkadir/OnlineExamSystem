...
{
    public abstract class OnlineExamSystemWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OnlineExamSystemWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OnlineExamSystemWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OnlineExamSystemDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OnlineExamSystemDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OnlineExamSystemDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OnlineExamSystemDbContext, Task<T>> func)
        {
            T result;
